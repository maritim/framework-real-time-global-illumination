#include "ScreenSpaceGlobalIlluminationRenderModule.h"
...
void ScreenSpaceGlobalIlluminationRenderModule::Init ()
{
	...
	*/
	...
	_renderPasses.push_back (ContainerRenderPass::Builder ()
		...
		.Attach (ContainerRenderPass::Builder ()
			...
			.Attach (new SSSubsurfaceScatteringAccumulationRenderPass ())
			.Build ())
